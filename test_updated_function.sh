...
show_menu_option() {
    local num="$1"
    local desc="$2"
    # Use printf to format the number and echo -e to properly interpret embedded color codes in the description
    printf "  ${GREEN}%-3s${NC}. "
    echo -e "$desc"
}

echo "Testing the updated show_menu_option function:"
